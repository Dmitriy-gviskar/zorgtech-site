...
export const LIST_SEO = {
  ...
  dealers: {
    ...
    description:
      'Дилерская сеть Zorgtech: скидки до 25%, персональный менеджер, маркетинговые материалы и гарантийный сервис. Оборудование производится в России и входит в реестр Минпромторга.',
    path: '/dealers',
  },
};
